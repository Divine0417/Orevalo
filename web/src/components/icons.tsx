...
export const Google = (p: IconProps) => (
  <Svg viewBox="0 0 24 24" fill="none" stroke="none" {...p}>
    ...
    <path fill="#34A853" d="M12 21.54c2.63 0 4.84-.87 6.45-2.35l-3.14-2.45c-.87.58-1.98.92-3.31.92-2.54 0-4.7-1.72-5.47-4.03H3.29v2.53A9.74 9.74 0 0 0 12 21.54Z" />
    <path fill="#FBBC05" d="M6.53 13.63a5.86 5.86 0 0 1 0-3.26V7.84H3.29a9.74 9.74 0 0 0 0 8.32l3.24-2.53Z" />
    <path fill="#EA4335" d="M12 6.34c1.43 0 2.72.49 3.73 1.46l2.8-2.8C16.84 3.44 14.63 2.46 12 2.46a9.74 9.74 0 0 0-8.71 5.38l3.24 2.53C7.3 8.06 9.46 6.34 12 6.34Z" />
  </Svg>
)
